# Available .WORKS One-Word Domains (10,499)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-10%2C499%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **10,499 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 10,499 domains · **Median ask:** $20.97 · **High-demand under $2,500:** 0
...
| buy.works  | resell    | —         | —             | high           | medium | 3      | Sav.com, LLC - 2 |
| ago.works  | premium   | $42.90    | $42.90        | medium         | low    | 3      | namecheap        |
| les.works  | available | $7.99     | —             | medium         | low    | 3      | name.com         |
| gas.works  | resell    | —         | —             | high           | low    | 3      | Sav.com, LLC     |
| apt.works  | premium   | $123.75   | —             | high           | low    | 3      | name.com         |
...
| aged.works | available | $7.99     | $50.99        | high           | low    | 4      | name.com         |
| sun.works  | resell    | —         | —             | high           | medium | 3      | Sav.com, LLC     |
| axe.works  | premium   | $118.80   | $118.80       | medium         | low    | 3      | namesilo         |
| bern.works | available | $7.99     | —             | high           | low    | 4      | name.com         |
| way.works  | resell    | —         | —             | high           | low    | 3      | Porkbun LLC      |
| cry.works  | premium   | $78.54    | $78.54        | high           | low    | 3      | namesilo         |
| bury.works | available | $7.99     | —             | medium         | low    | 4      | name.com         |
| you.works  | resell    | —         | —             | high           | medium | 3      | Sav.com, LLC     |
| fan.works  | premium   | $500      | —             | high           | low    | 3      | name.com         |
| came.works | available | $7.99     | —             | high           | low    | 4      | name.com         |
| card.works | resell    | —         | —             | medium         | medium | 4      | Dynadot Inc      |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 10,499 live domains                        |
...
This list of .WORKS domain names features short, memorable one-word phrases — from settledown.works to bonvoyage.works — priced with a median ask around $21. The .WORKS extension offers an affordable entry point for founders seeking an ownable name and for investors tracking price across a large, active TLD. With 10,499 domains in this set, buyers can compare tone, length, and cost before committing to a single name.

- 10,499 one-word .WORKS domains in this selection
- Median ask near $21 — budget-friendly entry point
- Brandable, phrase-style names like bonappetit.works
...
> Unique Domains. *Available .WORKS One-Word Domains*. Version 2026-07-07. Public GitHub extract for the exact Unique Domains search represented by this repository.
