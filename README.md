# Available .WORKS One-Word Domains (22,224)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-22%2C224%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **22,224 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 22,224 domains · **Median ask:** $11.08 · **High-demand under $2,500:** 3
...
| ------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------------- |
| here.works    | available | —         | —             | high           | low    | 4      | —               |
| period.works  | available | $7.99     | —             | high           | low    | 6      | name.com        |
| perfect.works | resell    | —         | —             | high           | low    | 7      | Porkbun LLC     |
| own.works     | available | —         | —             | high           | low    | 3      | —               |
| YouTube.works | available | —         | —             | high           | medium | 7      | —               |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 22,224 live domains                        |
...
> Unique Domains. *Available .WORKS One-Word Domains*. Version 2026-09-18. Public GitHub extract for the exact Unique Domains search represented by this repository.
