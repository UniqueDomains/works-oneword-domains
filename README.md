...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C664%20rows-8250df">
...
Daily-updated dataset of available and resale .works one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Unique Domains counts can still change as the search refreshes.

**Public extract:** 7,664 rows · **Live catalog:** 7,664 domains
...
- `works.csv` — public CSV extract (7,664 rows)
- `works.json` — public JSON extract (7,664 rows)
...
| gold.works      | premium   | $520      | $520          | 72             | 48     | 4      | namecheap                                                 |
...
| trinity.works   | available | $7.99     | $50.99        | 72             | 30     | 7      | name.com                                                  |
...
| complex.works   | available | $7.99     | $50.99        | 111            | 25     | 7      | name.com                                                  |
...
| ----------------------- | ------------------------------------------------ |
| 7,664-row public sample | 7,664 live domains                               |
...
> Unique Domains. *Available .WORKS One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
