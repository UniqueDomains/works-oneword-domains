# Available .WORKS One-Word Domains (5,622,103)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C667%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C622%2C103%20domains-6f42c1">
...
> **Important:** this repository is a **public 7,667-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,103 domains** on the canonical page below.

**Public extract:** 7,667 rows · **Live catalog:** 5,622,103 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/works?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_works_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/works?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_works_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./works.csv">CSV</a> / <a href="./works.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_works_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_works_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .WORKS search](https://unique.domains/domains/tld/works?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_works_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .WORKS search](https://unique.domains/domains/tld/works?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_works_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./works.csv) or [Download JSON](./works.json)
...
- `works.csv` — public CSV extract (7,667 rows)
- `works.json` — public JSON extract (7,667 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,667-row public sample | 5,622,103 live domains                           |
...
| --------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------------------------------------------------------- |
| hidden.works    | available | $7.99     | $50.99        | 65             | 35     | 6      | name.com                                                  |
| trader.works    | resell    | $7.99     | —             | 70             | 34     | 6      | Sav.com, LLC                                              |
| gold.works      | premium   | $520      | $520          | 72             | 49     | 4      | namecheap                                                 |
| trinity.works   | available | $7.99     | $50.99        | 72             | 31     | 7      | name.com                                                  |
| amber.works     | resell    | —         | —             | 62             | 99     | 5      | Dynadot Inc                                               |
| car.works       | premium   | $520      | $520          | 94             | 46     | 3      | namecheap                                                 |
| ted.works       | available | $7.99     | —             | 72             | 30     | 3      | name.com                                                  |
| with.works      | resell    | —         | —             | 98             | 74     | 4      | Spaceship, Inc.                                           |
| insurance.works | premium   | $520      | $520          | 76             | 44     | 9      | namecheap                                                 |
| eight.works     | available | $7.99     | $50.99        | 102            | 26     | 5      | name.com                                                  |
| boss.works      | resell    | —         | —             | 76             | 73     | 4      | Sav.com, LLC - 14                                         |
...
| about.works     | premium   | $42.90    | $42.90        | 94             | 38     | 5      | namecheap                                                 |
| above.works     | available | $7.99     | $50.99        | 112            | 25     | 5      | name.com                                                  |
| news.works      | resell    | —         | —             | 100            | 64     | 4      | Edomains LLC                                              |
...
> Unique Domains. *Available .WORKS One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
